...
$(document).ready(function() {
  // Al cargar la página, verifica si hay credenciales almacenadas
  var storedUsername = localStorage.getItem('email');
  var storedPassword = localStorage.getItem('password');

  if (storedUsername && storedPassword) {
      // Si hay credenciales almacenadas, completa automáticamente el formulario
      $('#email').val(storedUsername);
  ...
  $('#loginForm').submit(function(event) {
      ...
      // Verifica si se debe recordar el inicio de sesión
      if (rememberMe) {
      ...
      // Aquí puedes enviar los datos del formulario a tu backend para procesar el inicio de sesión
      // Ejemplo:
